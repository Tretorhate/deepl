"""
Text Model Trainer
Handles training and evaluation of text classification models with regularization
"""
...
class TextTrainer:
    """Trainer for text classification models with early stopping and LR scheduling."""
...
if __name__ == '__main__':
    print("Text trainer module imported successfully")
